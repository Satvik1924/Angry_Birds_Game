...
public class EasyLevel extends InputAdapter implements Screen, ILevelScreen {
    ...
    private Sound music;
    private Animation<TextureRegion> record; // Specify Animation type
    ...
    public void update(float dt) {
        ...
        // Check if the bird was just thrown
    ...
    public boolean keyDown(int keycode) {
        ...
        if (keycode == Input.Keys.P) {
            isPaused = true;
            ((Game) Gdx.app.getApplicationListener()).setScreen(new Paused(game, this)); // Switch to Paused screen
        }
